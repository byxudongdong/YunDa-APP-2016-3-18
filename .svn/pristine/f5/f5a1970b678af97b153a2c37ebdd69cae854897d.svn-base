...
public class ListDataAdapter extends BaseAdapter{
	...
	private int index=-1;
	public ListDataAdapter(Context mContext,List<ListData> mList){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		mHolder.BigNumber.setText(mList.get(position).getBigNumber());
		mHolder.mNumber.setText(mList.get(position).getNumber());	
		if (position==index) {
