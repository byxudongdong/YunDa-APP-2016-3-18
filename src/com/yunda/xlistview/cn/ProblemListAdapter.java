...
public class ProblemListAdapter extends BaseAdapter{
	...
	public ProblemListAdapter(Context mContext,List<Problem> mList){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		Holder mHolder;
		if (convertView==null) {
			convertView=inflater.inflate(R.layout.problemadapterxml, null, false);
			mHolder=new Holder(convertView);
			convertView.setTag(mHolder);
		}else {
			mHolder=(Holder) convertView.getTag();
		}
		mHolder.mNumberCode.setText(mList.get(position).getCode());
		mHolder.mProblemName.setText(mList.get(position).getProblem());
		return convertView;
	}
	class Holder{
		TextView mNumberCode,mProblemName;
		public Holder(View view){
			mNumberCode=(TextView) view.findViewById(R.id.numbercode);
			mProblemName=(TextView) view.findViewById(R.id.problem);
		}
	}
}
