...
public class DialogHomeActivity extends Activity implements ExpandableListView.OnChildClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        testItems.add(new DialogMenuItem("收藏", R.drawable.ic_winstyle_favor));
        testItems.add(new DialogMenuItem("下载", R.drawable.ic_winstyle_download));
        testItems.add(new DialogMenuItem("分享", R.drawable.ic_winstyle_share));
        testItems.add(new DialogMenuItem("删除", R.drawable.ic_winstyle_delete));
        testItems.add(new DialogMenuItem("歌手", R.drawable.ic_winstyle_artist));
        testItems.add(new DialogMenuItem("专辑", R.drawable.ic_winstyle_album));
